...
**Status:** phases 0–4 implemented (framework 0.9.2, ArtCreator 0.2.0); phase 5 first slice implemented (framework 0.9.3, ArtCreator 0.3.0), the rest open
**Date:** 2026-09-15
