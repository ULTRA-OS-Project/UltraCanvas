...
content.AddTitle("Sales 2026-08")                       // bold, titleFontSize
       ...
       .AddRow("Africa", "312 t", "+0.4 %")             // three-column table row
       .AddRow(Color(15,157,88,255), "Americas", "986 t", "-1.7 %")
...
- **Column alignment** is definable per column, separately for the two- and
  three-column table (`TooltipColumnAlign::Left | Center | Right`):

  ```cpp
  content.SetColumnAlignment(TooltipColumnAlign::Left,     // two-column rows
                             TooltipColumnAlign::Right);
  content.SetColumnAlignment(TooltipColumnAlign::Left,     // three-column rows
...
```cpp
enum class TooltipColumnAlign { Left, Center, Right };  // row cell placement
