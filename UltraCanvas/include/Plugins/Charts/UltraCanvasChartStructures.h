...
// =============================================================================
    ...
    struct PlotArea {
        ...
        PlotArea(float x_pos, float y_pos, float w, float h) : x(x_pos), y(y_pos), width(w), height(h) {}
    ...
    struct DataBounds {
        ...
        DataBounds() : minX(0), maxX(0), minY(0), maxY(0), minZ(0), maxZ(0), hasData(false) {}

        DataBounds(double min_x, double max_x, double min_y, double max_y, double min_z = 0, double max_z = 0)
...
// =============================================================================
    ...
    public:
        ChartCoordinateTransform(const PlotArea& plot, const DataBounds& bounds)
