...
//}
//bool RestorePixelRegion(const Rect2Di& region, IPixelBuffer* buffer) {
//    IRenderContext* ctx = GetRenderContext();
//    return ctx->RestorePixelRegion(region, buffer);
//}
////void SaveRegionAsImage(const Rect2Di& region, IPixelBuffer& buffer) {
////    IRenderContext* ctx = GetRenderContext();
...
//}
//
//void ctx->SetStrokeColor(const Color& color) {
//    IRenderContext* ctx = GetRenderContext();
...
//}
//
//void ctx->SetFont(const std::string& fontFamily, float fontSize) {
//    IRenderContext* ctx = GetRenderContext();
...
//}
//
//void SetDrawingStyle(const DrawingStyle& style) {
//    IRenderContext* ctx = GetRenderContext();
