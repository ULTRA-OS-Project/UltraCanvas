...
namespace UltraCanvas {
    namespace CSSLayout {
        ...
        void ArrangeBlock (Element& e, const LayoutRect& finalRect,  const LayoutContext& ctx);
        ...
        void ArrangeFlex  (Element& e, const LayoutRect& finalRect,  const LayoutContext& ctx);
        ...
        void ArrangeGrid  (Element& e, const LayoutRect& finalRect,  const LayoutContext& ctx);
