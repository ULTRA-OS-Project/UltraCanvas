...
namespace UltraCanvas {
    ...
    namespace {
        ...
        // context, neither of which a background decode has. The drawing is
        // UltraCanvasModelRaster.h, shared with the media viewer's non-GL
        // fallback; kModelPreviewTriangleCap lives there with it.
    ...
    void UltraCanvasFilerWidget::ContinuePendingDelete() {
        ...
        while (pendingDelete && pendingDelete->next < pendingDelete->victims.size()) {
            ...
            if (e.isReadOnly) {
                ...
                else { ShowDeleteProblemDialog(e, DeleteProblemKind::WriteProtected, {}); return; }
            ...
            if (ec) {
                ...
                ShowDeleteProblemDialog(e, needsPermission
                        ? DeleteProblemKind::NeedsPermission
                        : DeleteProblemKind::Failed, ec.message());
                return;
            }
