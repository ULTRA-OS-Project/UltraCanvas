...
#include <winreg.h>    // RegGetValueW (Google Drive mount point)
...
// GetCloudStorageFolders() reads the Dropbox info.json through the framework's
// own JSON API rather than pattern-matching the file.
