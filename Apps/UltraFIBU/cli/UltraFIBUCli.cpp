// Apps/UltraFIBU/cli/UltraFIBUCli.cpp
// The command-line front end to the UltraFIBU engine.
//
...
// Whether this program also has the window. Set once by Kommandozeile() and
...
void PrintUsage() {
    ...
    if (gMitFenster)
        std::printf(
            ...
            "Formular, in dem eine neue angelegt oder eine bestehende gewählt wird.\n");
    std::printf(
        "\n"
        "Befehle:\n"
...
// The one list of commands. The dispatch below and IstBefehl() both read it,
// so the program can never take a command for a file name - or a file name for
// a command - because a name was added in one place and not the other.
const Befehl kBefehle[] = {
    { "einrichten",            Einrichten },
    { "info",                  Info },
    { "konten",                Konten },
    { "partner",               PartnerListeZeigen },
    { "partner-neu",           PartnerNeu },
    { "ustid",                 UstIdPruefen },
    { "steuerwahl",            Steuerwahl },
    { "termine",               Termine },
    { "perioden",              Perioden },
    ...
    { "belege",                BelegeZeigen },
    { "buchen",                BelegBuchen },
    { "storno",                BelegStornieren },
    { "zahlung",               ZahlungBuchen },
    { "journal",               JournalZeigen },
    { "salden",                SaldenZeigen },
    { "pruefen",               KettePruefen },
    { "rechnung-pdf",          RechnungDrucken },
    { "datev-export",          DatevExport },
    { "datev-pruefen",         DatevPruefen },
    { "datev-import",          DatevImport },
    { "datev-importe",         DatevImporte },
    { "konten-import",         KontenImport },
    { "beleg-import",          BelegImport },
    { "oss",                   Oss },
    { "lieferschwelle",        Lieferschwelle },
    { "eu-saetze",             EuSaetze },
    { "eu-satz-neu",           EuSatzNeu },
    { "eu-satz-loeschen",      EuSatzLoeschen },
    { "eu-saetze-uebernehmen", EuSaetzeUebernehmen },
    { "ustva",                 Ustva },
    { "ustva-xml",             UstvaXml },
    { "meldungen",             Meldungen },
    { "meldung-quittung",      MeldungQuittung },
    { "bankkonto-neu",         BankkontoNeu },
...
bool UltraFIBU::IstBefehl(const std::string& wort) {
    return wort == "--help" || wort == "-h" || wort == "hilfe" ||
           wort == "--version" || FindeBefehl(wort) != nullptr;
}
...
int UltraFIBU::Kommandozeile(int argc, char** argv, bool mitFenster) {
    ...
    if (const Befehl* b = FindeBefehl(befehl)) return b->ausfuehren(argc, argv);
