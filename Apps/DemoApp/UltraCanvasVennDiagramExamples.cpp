...
namespace UltraCanvas {
    ...
    std::shared_ptr<UltraCanvasUIElement> UltraCanvasDemoApplication::CreateVennDiagramExamples() {
        auto mainContainer = std::make_shared<UltraCanvasContainer>("vennMainContainer", 0, 0, 1200, 800);
        mainContainer->SetBackgroundColor(Color(248, 249, 250, 255));
        
        auto headerContainer = std::make_shared<UltraCanvasContainer>("headerContainer", 0, 0, 1200, 90);
        headerContainer->SetBackgroundColor(Color(255, 255, 255, 255));
        mainContainer->AddChild(headerContainer);
        
        auto mainTitle = std::make_shared<UltraCanvasLabel>("mainTitle", 30, 15, 1140, 35);
        ...
        auto subtitle = std::make_shared<UltraCanvasLabel>("subtitle", 30, 50, 800, 30);
        ...
        auto contentContainer = std::make_shared<UltraCanvasContainer>("contentContainer", 0, 90, 1200, 710);
        mainContainer->AddChild(contentContainer);
        
        auto leftSidebar = std::make_shared<UltraCanvasContainer>("leftSidebar", 20, 20, 220, 670);
        leftSidebar->SetBackgroundColor(Color(255, 255, 255, 255));
        leftSidebar->SetPadding(15);
        contentContainer->AddChild(leftSidebar);
        
        auto controlsTitle = std::make_shared<UltraCanvasLabel>("controlsTitle", 0, 0, 190, 30);
        ...
        auto layoutLabel = std::make_shared<UltraCanvasLabel>("layoutLabel", 0, 45, 190, 20);
        ...
        auto layoutSelector = std::make_shared<UltraCanvasDropdown>("layoutSelector", 0, 68, 190, 28);
        ...
        auto styleLabel = std::make_shared<UltraCanvasLabel>("styleLabel", 0, 110, 190, 20);
        ...
        auto styleSelector = std::make_shared<UltraCanvasDropdown>("styleSelector", 0, 133, 190, 28);
        ...
        auto tabbedContainer = std::make_shared<UltraCanvasTabbedContainer>("vennTabs", 260, 20, 680, 580);
        tabbedContainer->SetTabPosition(TabPosition::Top);
        contentContainer->AddChild(tabbedContainer);
        
        auto rightSidebar = std::make_shared<UltraCanvasContainer>("rightSidebar", 960, 20, 220, 580);
        rightSidebar->SetBackgroundColor(Color(255, 255, 255, 255));
        rightSidebar->SetPadding(15);
        contentContainer->AddChild(rightSidebar);
        
        auto statsTitle = std::make_shared<UltraCanvasLabel>("statsTitle", 0, 0, 190, 30);
        ...
        auto statsPanel = std::make_shared<UltraCanvasLabel>("statsPanel", 0, 40, 190, 180);
        ...
        auto legendTitle = std::make_shared<UltraCanvasLabel>("legendTitle", 0, 240, 190, 30);
        ...
        auto legendPanel = std::make_shared<UltraCanvasLabel>("legendPanel", 0, 280, 190, 160);
        ...
        auto statusBar = std::make_shared<UltraCanvasLabel>("statusBar", 260, 610, 680, 60);
        ...
        // TAB 1: TWO CIRCLES
        auto twoCirclesTab = std::make_shared<UltraCanvasContainer>("twoCirclesTab", 0, 0, 680, 542);
        twoCirclesTab->SetBackgroundColor(Color(255, 255, 255, 255));
        
        auto twoCirclesTitle = std::make_shared<UltraCanvasLabel>("twoCirclesTitle", 20, 20, 640, 35);
        ...
        auto twoCirclesVenn = std::make_shared<UltraCanvasVennDiagramElement>("twoCirclesVenn", 90, 100, 500, 400);
        ...
        // TAB 2: THREE CIRCLES
        auto threeCirclesTab = std::make_shared<UltraCanvasContainer>("threeCirclesTab", 0, 0, 680, 542);
        threeCirclesTab->SetBackgroundColor(Color(255, 255, 255, 255));
        
        auto threeCirclesTitle = std::make_shared<UltraCanvasLabel>("threeCirclesTitle", 20, 20, 640, 35);
        ...
        auto threeCirclesVenn = std::make_shared<UltraCanvasVennDiagramElement>("threeCirclesVenn", 90, 100, 500, 400);
        ...
        // TAB 3: FOUR CIRCLES
        auto fourCirclesTab = std::make_shared<UltraCanvasContainer>("fourCirclesTab", 0, 0, 680, 542);
        fourCirclesTab->SetBackgroundColor(Color(255, 255, 255, 255));
        
        auto fourCirclesTitle = std::make_shared<UltraCanvasLabel>("fourCirclesTitle", 20, 20, 640, 35);
        ...
        auto fourCirclesVenn = std::make_shared<UltraCanvasVennDiagramElement>("fourCirclesVenn", 90, 100, 500, 400);
        ...
        auto cloudTab = std::make_shared<UltraCanvasContainer>("cloudTab", 0, 0, 680, 542);
        cloudTab->SetBackgroundColor(Color(255, 255, 255, 255));
        
        auto cloudTitle = std::make_shared<UltraCanvasLabel>("cloudTitle", 20, 20, 640, 35);
        ...
        auto cloudVenn = std::make_shared<UltraCanvasVennDiagramElement>("cloudVenn", 90, 100, 500, 400);
        ...
        // TAB 5: CUSTOM PRESET
        auto customTab = std::make_shared<UltraCanvasContainer>("customTab", 0, 0, 680, 542);
        customTab->SetBackgroundColor(Color(255, 255, 255, 255));
        
        auto customTitle = std::make_shared<UltraCanvasLabel>("customTitle", 20, 20, 640, 35);
        ...
        auto customVenn = std::make_shared<UltraCanvasVennDiagramElement>("customVenn", 90, 100, 500, 400);
