...
// ===== IMAGE PERFORMANCE TEST SCREEN =====
    std::shared_ptr<UltraCanvasUIElement> UltraCanvasDemoApplication::CreateImagePerformanceTest() {
        ...
        imageDropdown->AddItem("GIF sample (85Kb)", "media/images/dice.gif");
        imageDropdown->AddItem("WEBP sample (62KB)", "media/images/dice.webp");
        imageDropdown->AddItem("BMP sample (1920Kb)", "media/images/dice.bmp");
        imageDropdown->AddItem("TIFF sample (1920KB)", "media/images/dice.tiff");
        imageDropdown->AddItem("AVIF sample (13Kb)", "media/images/dice.avif");
        imageDropdown->AddItem("HEIC sample (26Kb)", "media/images/dice.heic");
        imageDropdown->AddItem("QOI sample (519Kb)", "media/images/dice.qoi");
        ...
        imageDropdown->AddItem("Icon, small GIF (133b)", "media/images/test_small.gif");
        ...
        imageDropdown->AddItem("Icon, small AVIF (446b)", "media/images/test_small.avif");
        imageDropdown->AddItem("Icon, small HEIC (708b)", "media/images/test_small.avif");
        imageDropdown->AddItem("Icon, small QOI (367b)", "media/images/test_small.qoi");
