...
// ===== MAIN DEMO APPLICATION CLASS =====
    ...
    public:
        ...
        std::shared_ptr<UltraCanvasUIElement> CreateFilerExamples();
        ...
        // One vertical tab page showing a bundled sample file (media/textsamples)
        // rendered live by UltraCanvasTextArea's syntax renderer for `language`.
        std::shared_ptr<UltraCanvasUIElement> CreateTextSampleTabPage(const std::string& language,
        ...
        std::shared_ptr<UltraCanvasUIElement> CreateChordChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateCircularInfoGraphicExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateCircleDiagramExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateRadialBarChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateCircularProgressChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreatePolarChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateChartEngineExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateRadarChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateParallelCoordinateChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateHeatmapExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateContourChartExamples();
        std::shared_ptr<UltraCanvasUIElement> CreatePacketDiagramExamples();
        ...
        std::shared_ptr<UltraCanvasUIElement> CreateFishboneDiagramExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateMatrixDiagramExamples();
        ...
        std::shared_ptr<UltraCanvasUIElement> CreateClassDiagramExamples();
        std::shared_ptr<UltraCanvasUIElement> CreateSequenceDiagramExamples();
        ...
        std::shared_ptr<UltraCanvasUIElement> CreateMindMapExamples();
