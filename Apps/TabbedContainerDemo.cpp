...
To compile this demo application on Linux with UltraCanvas:

1. Install dependencies:
   sudo apt-get install libx11-dev libcairo2-dev libpango1.0-dev libfreetype6-dev

2. Compile with proper includes:
   g++ -std=c++20 -I../include -o TabbedContainerDemo \
       TabbedContainerDemo.cpp \
...
✅ **Complete Tabbed Container Showcase**:
- Main tabbed container with 15+ tabs to trigger dropdown
- Nested tabbed container with different positioning
- Interactive content panels with buttons and text inputs
- Real-time status updates and event feedback

✅ **Dropdown Search Demonstration**:
- Search threshold demonstration (>5 tabs)
- Real-time filtering with visual feedback
- Search icon (🔍) and placeholder text
- Keyboard navigation (Escape, Enter, Backspace)

✅ **Interactive Controls**:
- Add/Remove tabs dynamically
- Toggle dropdown position (Left/Right/Off)
- Toggle search functionality on/off
- Tab reordering and close button testing

✅ **Visual Feedback**:
- Status updates for all user actions
- Color-coded feedback messages
- Tab change, close, and reorder notifications
- Real-time tab count and search state display

✅ **Comprehensive Testing**:
- Multiple tab layouts and styles
- Different content types per tab
- Nested container demonstration
- Keyboard shortcuts and accessibility

This demo provides a complete testing environment for all enhanced tabbed
container features while following UltraCanvas framework guidelines!
*/