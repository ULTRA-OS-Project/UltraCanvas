...
UIScript and the channel share one dictionary).
...
`com-automation`, at-rest journal encryption via UltraCrypt. **UIScript**
(`Docs/Research/UIScriptSpecification.md`: the AppleScript-class language,
