...
data model, API, broker, adapters, security, delivery plan).
...
`com-automation`, at-rest journal encryption via UltraCrypt. UltraScript — the
scripting language for repeating tasks across applications — is a client of
the Phase 3 command surface and is specified separately.
